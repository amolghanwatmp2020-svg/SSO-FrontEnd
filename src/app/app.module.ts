...
export function MSALInstanceFactory(): IPublicClientApplication {
  return new PublicClientApplication({
   auth: {
      ...
      redirectUri: 'https://sso-b3fkfeb7f9d5hwen.indonesiacentral-01.azurewebsites.net/', // Your Angular app's redirect URI (must match Azure AD registration)
      postLogoutRedirectUri: 'https://sso-b3fkfeb7f9d5hwen.indonesiacentral-01.azurewebsites.net/', // Where to redirect after logout
    },
    cache: {
...
export function MSALInterceptorConfigFactory() {
  ...
  protectedResourceMap.set('https://sso-b3fkfeb7f9d5hwen.indonesiacentral-01.azurewebsites.net/api', ['api://59de5ef0-7b5c-4d4a-833d-e145edc85013/access_as_user']);
